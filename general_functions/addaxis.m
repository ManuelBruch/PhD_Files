...
%  plot in new axis to get the automatically generated ylimits
  ...
  % added by me to force Ymin = 0 (Manuel, 16.02.2021)
  yl2(1) = 0;


  set(h_ax,'yaxislocation',side);
%   set(h_ax,'color',get(gcf,'color')); % changed by me to try and get white
%   background for all axes
  set(h_ax,'color','w');
  set(h_ax,'box','off');
  set(h_ax,'xtick',[]);
